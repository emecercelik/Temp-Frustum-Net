...
#LOG_PATH=/root_3d_log/kitti_onlycar_time
#kitti_onlycar_time
#kitti_attention_whl
...
python plot_histogram.py	--class_names car \
				--path_to_log $LOG_PATH/log_time_s4 \
				--drive_ids 3 4 43 44\
...
python plot_histogram.py	--class_names car \
				--path_to_log $LOG_PATH/log_time_s17 \
				--drive_ids 3 4 43 44\
				--path_to_gts $GTS_PATH \
				--path_to_hist $LOG_PATH/ \
				--difficulty 0 1 2 3 
...
python plot_histogram.py	--class_names car \
				--path_to_log $LOG_PATH/log_time_s3 \
				--drive_ids 3 4 43 44\
				--path_to_gts $GTS_PATH \
				--path_to_hist $LOG_PATH/ \
				--difficulty 0 1 2 3 

#LOG_PATH=/root_3d_log/kitti_attention_whl

#python plot_histogram.py	--class_names car \
#				--path_to_log $LOG_PATH/log_time_s15 \
