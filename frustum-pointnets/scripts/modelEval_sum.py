...
def get_max_in_one_log(results_dict,detection_type='car_detection_3d'):
    '''
...
def read_all_eval_dicts(main_path,prefix,log_indices,args):
    ...
    for log_index in log_indices:
        ...
        max_logs[log_name] = get_max_in_one_log(dicts[log_name],detection_type=args.detection_type)
